...
| ドキュメント集約 | `studio/README.md` | ヒューマン向けドキュメント一覧。 |
...
```
/README.md                 # リポジトリ概要
/studio/README.md            # ヒューマン向けハブ
/studio/20-process/README.md        # プロセスガイド全体
/studio/20-process/agents/README.md # このガイド
/AGENTS.md                 # エージェント向けクイックスタート
/studio/00-foundation/documentation/README.md      # ドキュメントルール/SOP
/studio/00-foundation/documentation/INDEX.md       # ルール/SOP索引
/studio/10-governance/framework/README.md          # ガバナンス詳細
/studio/20-process/development/README.md # 開発プロセス詳細
/studio/50-tooling/claude/README.md            # Claude セットアップガイド
...
- `/constitution`, `/inception`, `/construction` などのスラッシュコマンドは Claude のチャット上で実行する。必要なコマンドが表示されない場合は `.claude/commands/<name>.md` を新規作成または更新する。テンプレート整備手順は [studio/10-governance/framework/README.md](../../10-governance/framework/README.md#スラッシュコマンドテンプレート運用) と [studio/50-tooling/claude/README.md](../../50-tooling/claude/README.md) を参照。
