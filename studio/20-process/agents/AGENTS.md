...
- `studio/20-process/agents/README.md` の要点を抜粋し、タスク遂行時のチェックリストとして利用する。
...
- [ ] 必要なテスト・検証ステップを `studio/20-process/development/README.md` で確認したか。
...
テンプレート
- ひな型: `studio/60-templates/exec-plan.md` をコピーして `plans.md` を作成。
